...
- (UICollectionView *)createCollectionView
{
    ...
    if (!self.activeModule) {
        self.activeModule = [ARArtworkMasonryModule masonryModuleWithLayout:ARArtworkMasonryLayout2Column andStyle:AREmbeddedArtworkPresentationStyleArtworkMetadata];
    }
